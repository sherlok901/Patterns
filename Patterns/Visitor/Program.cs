...
namespace Visitor
{
    ...
    class HtmlVisitor : IVisitor
    {
        ...
        {
            Console.WriteLine(Environment.NewLine + "Person html" + Environment.NewLine);
        ...
        {
            Console.WriteLine(Environment.NewLine + "Company html" + Environment.NewLine);
            string result = "<table><tr><td>Свойство<td><td>Значение</td></tr>";
            result += "<tr><td>Name<td><td>" + acc.Name + "</td></tr>";
    ...
    class XmlVisitor : IVisitor
    {
        public void VisitPersonAcc(Person acc)
        {
            Console.WriteLine(Environment.NewLine + "Person xml" + Environment.NewLine);
        ...
        public void VisitCompanyAc(Company acc)
        {
            Console.WriteLine(Environment.NewLine + "Company xml" + Environment.NewLine);
